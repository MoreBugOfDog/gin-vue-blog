...
func generateDefaultConfigs(db *gorm.DB) {
	...
	configs := []model.Config{
		...
		{Key: "website_name", Value: "多bug的啸天犬-个人博客", Desc: "网站名称"},
		{Key: "website_author", Value: "多bug的啸天犬", Desc: "对 阵雨 的项目进行二开"},
		{Key: "website_intro", Value: "往事随风而去", Desc: "网站介绍"},
		{Key: "website_notice", Value: "欢迎来到多bug的啸天犬的个人博客，项目还在开发中...", Desc: "网站公告"},
		{Key: "website_createtime", Value: time.Now().Format(time.DateTime), Desc: "网站创建日期"},
		{Key: "website_record", Value: "暂未备案", Desc: "网站备案号"},
		{Key: "qq", Value: "123456789", Desc: "QQ"},
		{Key: "github", Value: "https://github.com/MoreBugOfDog", Desc: "github"},
		{Key: "gitee", Value: "https://gitee.com/MoreBugOfDog", Desc: "gitee"},
